...
namespace Luma.SimpleEntity
{
    ...
    public interface IDomainServiceClientCodeGenerator
    {
        ...
        /// <param name="domainServiceDescriptions">The set of <see cref="EntityDescription"/> 
        ...
        string GenerateCode(ICodeGenerationHost codeGenerationHost, IEnumerable<EntityDescription> domainServiceDescriptions, ClientCodeGenerationOptions options);
    }
}
