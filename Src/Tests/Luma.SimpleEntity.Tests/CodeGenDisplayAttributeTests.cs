...
namespace Luma.SimpleEntity.Tests
{
    ...
    {
        [TestMethod]
        [Description("Resourced [Display] strings succeeds")]
        public void CodeGen_Attribute_DisplayAttribute_Resourced()
        {
            ...
            string generatedCode = TestHelper.GenerateCodeAssertSuccess("C#", new Type[] { typeof(Mock_CG_DisplayAttr_Entity_Shared_ResourceType) }, null, sts);
        ...
        [TestMethod]
        [Description("Resourced [Display] strings in a different namespace succeeds")]
        ...
        [TestMethod]
        [Description("Resourced [Display] strings logs error if resource type is private")]
    ...
    public class Mock_CG_DisplayAttr_Entity_Shared_ResourceType
    {
        [Key]
    ...
    public class Mock_CG_DisplayAttr_Entity_Shared_ResourceType_DifferentNamespace
    {
        [Key]
        // Demonstrates fully resourced display with all resources corresponding to properties
    ...
    public class Mock_CG_DisplayAttr_Entity_Unshared_ResourceType
    {
    ...
    public class Mock_CG_DisplayAttr_Entity_Private_ResourceType
    {
