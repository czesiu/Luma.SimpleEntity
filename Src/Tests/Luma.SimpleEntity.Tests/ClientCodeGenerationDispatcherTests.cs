...
namespace Luma.SimpleEntity.Tests
{
    ...
    public class ClientCodeGenerationDispatcherTests
    {
        ...
        //    using (ClientCodeGenerationDispatcher dispatcher = new ClientCodeGenerationDispatcher())
        //    {
        //        string[] compositionAssemblies = new string[] { Assembly.GetExecutingAssembly().Location, typeof(TextTemplate.ClientCodeGenerator).Assembly.Location };
        ...
        //    using (ClientCodeGenerationDispatcher dispatcher = new ClientCodeGenerationDispatcher())
        //    {
        //        string[] compositionAssemblies = new string[] { Assembly.GetExecutingAssembly().Location, typeof(T4ClientCodeGenerator).Assembly.Location };
        ...
        //        IClientCodeGenerator generator = dispatcher.FindCodeGenerator(host, options, compositionAssemblies, CodeDomClientCodeGenerator.GeneratorName);
        //        Assert.IsNotNull(generator, "the dispatcher did not find any code generator");
        ...
        //        EntityDescription dsd = EntityDescription.GetDescription(typeof(Dispatcher));
        //        string generatedCode = generator.GenerateCode(host, new EntityDescription[] { dsd }, options);
        ...
        //    using (ClientCodeGenerationDispatcher dispatcher = new ClientCodeGenerationDispatcher())
        //    {
        //        string[] compositionAssemblies = new string[] { typeof(T4ClientCodeGenerator).Assembly.Location };

        //        IClientCodeGenerator generator = dispatcher.FindCodeGenerator(host, options, compositionAssemblies, null);
        //        Assert.IsNotNull(generator, "the dispatcher did not find any code generator");
        //        Assert.AreEqual(generator.GetType(), typeof(T4ClientCodeGenerator), "dispatcher found " + generator.GetType() + " but should have found T4ClientProxyGenerator");

        //        EntityDescription dsd = EntityDescription.GetDescription(typeof(DispatcherDS));
        //        string generatedCode = generator.GenerateCode(host, new EntityDescription[] { dsd }, options);

        //        Assert.IsFalse(string.IsNullOrEmpty(generatedCode), "expected T4 generator to generate code");
        //        TestHelper.AssertGeneratedCodeContains(generatedCode, T4ClientCodeGenerator.GeneratedBoilerPlate);
        ...
        //        IClientCodeGenerator generator = dispatcher.FindCodeGenerator(host, options, compositionAssemblies, typeof(T4ClientCodeGenerator).AssemblyQualifiedName);
        ...
        //                            "    " + T4ClientCodeGenerator.GeneratorName + Environment.NewLine;
    ...
    [ClientCodeGenerator(MockCodeGenerator.GeneratorName, "C#")]
    public class MockCodeGenerator : IClientCodeGenerator
    {
        ...
        public string GenerateCode(ICodeGenerationHost host, IEnumerable<EntityDescription> entityDescriptions, ClientCodeGenerationOptions options)
        {
            ...
            Assert.IsNotNull(entityDescriptions, "entityDescriptions cannot be null when code generator is called");
    ...
    // [ClientCodeGenerator("ThrowingCtorCodeGenerator", "C#")]
    public class ThrowingCtorCodeGenerator : IClientCodeGenerator
    {
    ...
    [ClientCodeGenerator(MockFSharpCodeGenerator1.GeneratorName, "F#")]
    public class MockFSharpCodeGenerator1 : IClientCodeGenerator
    {
    ...
    [ClientCodeGenerator(MockFSharpCodeGenerator1.GeneratorName, "F#")]
    public class MockFSharpCodeGenerator2 : IClientCodeGenerator
    {
        public string GenerateCode(ICodeGenerationHost codeGenerationHost, IEnumerable<EntityDescription> entityDescriptions, ClientCodeGenerationOptions options)
        {
            throw new NotImplementedException();
    ...
    public class MockGSharpCodeGeneratorBase : IClientCodeGenerator
    {
        public const string GeneratedCode = "Base generated code";

        public virtual string GenerateCode(ICodeGenerationHost codeGenerationHost, IEnumerable<EntityDescription> entityDescriptions, ClientCodeGenerationOptions options)
        {
            return MockGSharpCodeGeneratorBase.GeneratedCode;
        }
    }

    [ClientCodeGenerator(MockGSharpCodeGeneratorDerived.GeneratorName, "G#")]
    public class MockGSharpCodeGeneratorDerived : MockGSharpCodeGeneratorBase
    {
        ...
        public override string GenerateCode(ICodeGenerationHost codeGenerationHost, IEnumerable<EntityDescription> entityDescriptions, ClientCodeGenerationOptions options)
        {
