...
namespace Luma.SimpleEntity.Tests
{
    ...
    /// </summary>
    [TestClass]
    public class CleanClientFilesTaskTests
    {
        [DeploymentItem(@"Tests\Luma.SimpleEntity.Tests\ProjectPath.txt", "CLRCF1")]
        [Description("CleanClientFilesTask deletes ancillary files in OutputPath and code in GeneratedOutputPath")]
        [TestMethod]
        ...
        [Description("CleanClientFilesTask.SafeFileDelete catches expected exceptions")]
        [TestMethod]
