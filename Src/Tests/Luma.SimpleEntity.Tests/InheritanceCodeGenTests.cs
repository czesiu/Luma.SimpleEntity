...
namespace Luma.SimpleEntity.Tests
{
    ...
    public class InheritanceCodeGenTests
    {
        ...
        [DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH1")]
        public void Inherit_Gen_EntityCatalog()
        {
            using (var asmGen = new AssemblyGenerator("CG_INH1", true /*isCSharp*/,
                new[] { typeof(Inherit_Basic_Root), typeof(Inherit_Basic_Derived) }))
            {
                // ---------------------------------------------------
                // Get the EntityCatalog from our helper
                // ---------------------------------------------------
                IEnumerable<EntityDescription> dsds = asmGen.EntityCatalog.EntityDescriptions;
                Assert.IsNotNull(dsds, "EntityDescriptions expected");
                Assert.AreEqual(1, dsds.Count(), "Should have seen just 1 domain service description");
                EntityDescription dsd = dsds.First();
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH4")]
        ...
        //                                            "CG_INH4",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_Assoc_UD2IR) }))
        //        {
        //            Assembly assy = asmGen.GeneratedAssembly;
        //            Assert.IsNotNull(assy, "Assembly failed to build: " + asmGen.ConsoleLogger.Errors);
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH5")]
        ...
        //                                            "CG_INH5",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_Assoc_BD2IR) }))
        //        {
        //            Assembly assy = asmGen.GeneratedAssembly;
        //            Assert.IsNotNull(assy, "Assembly failed to build: " + asmGen.ConsoleLogger.Errors);
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH6")]
        ...
        //                                            "CG_INH6",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_Assoc_BD2ID) }))
        //        {
        //            Assembly assy = asmGen.GeneratedAssembly;
        //            Assert.IsNotNull(assy, "Assembly failed to build: " + asmGen.ConsoleLogger.Errors);
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH7")]
        ...
        //                                            "CG_INH7",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_Assoc_BD2ID_OneToMany) }))
        //        {
        //            Assembly assy = asmGen.GeneratedAssembly;
        //            Assert.IsNotNull(assy, "Assembly failed to build: " + asmGen.ConsoleLogger.Errors);
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH8")]
        ...
        //                                            "CG_INH8",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_Assoc_BD2ID_ManyToOne) }))
        //        {
        //            Assembly assy = asmGen.GeneratedAssembly;
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH9")]
        ...
        //                                            "CG_INH9",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_Projection_BD2ID) }))
        //        {
        //            EntityCatalog cat = asmGen.EntityCatalog;
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH10")]
        ...
        //                                            "CG_INH10",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_Projection_BD2ID_Reversed) }))
        //        {
        //            EntityCatalog cat = asmGen.EntityCatalog;
...
//        [DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH11")]
...
//        [DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH12")]
...
//                            {
//                                using System;
//                                using Luma.SimpleEntity.Client;
...
//
//                            Imports System
//                            Imports Luma.SimpleEntity.Client
//
//                            Namespace Inheritance.Tests
//                                
...
//        }
        ...
        //[TestMethod]
        //[Description("Inheritance: validates the EntityDescription builds correct known type hierarchy for abstracts")]
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH13")]
        //public void Inherit_EntityDescription_Type_Hierarchies()
        //{
        //    foreach (bool isCSharp in new bool[] { true, false })
        //    {
        //        using (AssemblyGenerator asmGen = new AssemblyGenerator(
        //                                            "CG_INH13",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_Abstract_Root) }))
        //        {
        //            EntityDescription dsd = asmGen.EntityCatalog.EntityDescriptions.FirstOrDefault();
        //            Assert.IsNotNull(dsd, "Expected EntityDescription");

        //            // There is only one root entity -- validate this
        //            Type[] rootTypes = dsd.EntityTypes.ToArray();
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH14")]
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH15")]
        ...
        //                                            "CG_INH15",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_No_Key) }))
        //        {
        ...
        //            string errorMessage = string.Format(CultureInfo.CurrentCulture, Resource.Entity_Has_No_Key_Properties, typeof(Inherit_No_Key_Entity).Name, typeof(Inherit_No_Key).Name);
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH16")]
        ...
        //                                            "CG_INH16",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_Derived_Key) }))
        //        {
        //            // Trigger code generation but don't attempt to build
        //            string generatedCode = asmGen.GeneratedCode;
        ...
        //            string errorMessage = string.Format(CultureInfo.CurrentCulture, Resource.DerivedEntityCannotHaveKey, "TheDerivedKey", typeof(Inherit_Derived_Key_Derived).Name);
        //            TestHelper.AssertContainsErrors(asmGen.ConsoleLogger, errorMessage);
        //        }
        //    }
        //}
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH17")]
        ...
        //                                            "CG_INH17",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_Missing_KnownType) }))
        //        {
        //            // Trigger code generation but don't attempt to build
        //            string generatedCode = asmGen.GeneratedCode;
        ...
        //            string errorMessage = string.Format(CultureInfo.CurrentCulture, Resource.KnownTypeAttributeRequired, typeof(Inherit_Missing_KnownType_Derived).Name, typeof(Inherit_Missing_KnownType_Root).Name);
        //            TestHelper.AssertContainsErrors(asmGen.ConsoleLogger, errorMessage);
        //        }
        //    }
        //}
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH18")]
        ...
        //                                            "CG_INH18",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_Polymorphic) }))
        //        {
        //            Assembly assy = asmGen.GeneratedAssembly;
        //            Assert.IsNotNull(assy, "Assembly failed to build: " + asmGen.ConsoleLogger.Errors);
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH19")]
        ...
        //                                            "CG_INH19",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_Polymorphic_New) }))
        //        {
        //            Assembly assy = asmGen.GeneratedAssembly;
        ...
        //            string errorMessage = string.Format(CultureInfo.CurrentCulture, Resource.Entity_Property_Redefined, typeof(Inherit_Polymorphic_New_Derived), "BaseProperty", typeof(Inherit_Polymorphic_New_Entity));
        //            TestHelper.AssertContainsErrors(asmGen.ConsoleLogger, errorMessage);

        //            //// Code gen should fail and log an error for the attempt to override BaseProperty on the non-exposed entity
        //            //errorMessage = string.Format(CultureInfo.CurrentCulture, Resource.Entity_Property_Redefined, typeof(Inherit_Polymorphic_New_Derived), "VirtualProperty", typeof(Inherit_Polymorphic_New_Entity));
        //            //TestHelper.AssertContainsErrors(asmGen.ConsoleLogger, errorMessage);
        //        }
        //    }
        //}
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH20")]
        ...
        //                                            "CG_INH20",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_Flatten) }))
        //        {
        //            Assembly assy = asmGen.GeneratedAssembly;
        //            Assert.IsNotNull(assy, "Assembly failed to build: " + asmGen.ConsoleLogger.Errors);
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH21")]
        ...
        //                                            "CG_INH21",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_No_Root_Insert) }))
        //        {
        //            // Trigger code generation but don't attempt to build
        //            string generatedCode = asmGen.GeneratedCode;
        ...
        //            string errorMessage = string.Format(CultureInfo.CurrentCulture, Resource.DomainOperation_Required_On_Root, "InsertIt", typeof(Inherit_Basic_Derived).Name, typeof(Inherit_Basic_Root).Name);
        //            TestHelper.AssertContainsErrors(asmGen.ConsoleLogger, errorMessage);
        //        }
        //    }
        //}
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH22")]
        ...
        //                                            "CG_INH22",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_No_Root_Update }))
        //        {
        //            // Trigger code generation but don't attempt to build
        //            string generatedCode = asmGen.GeneratedCode;
        ...
        //            string errorMessage = string.Format(CultureInfo.CurrentCulture, Resource.DomainOperation_Required_On_Root, "UpdateIt", typeof(Inherit_Basic_Derived).Name, typeof(Inherit_Basic_Root).Name);
        //            TestHelper.AssertContainsErrors(asmGen.ConsoleLogger, errorMessage);
        //        }
        //    }
        //}
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH23")]
        ...
        //                                            "CG_INH23",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_No_Root_Delete) }))
        //        {
        //            // Trigger code generation but don't attempt to build
        //            string generatedCode = asmGen.GeneratedCode;
        ...
        //            string errorMessage = string.Format(CultureInfo.CurrentCulture, Resource.DomainOperation_Required_On_Root, "DeleteIt", typeof(Inherit_Basic_Derived).Name, typeof(Inherit_Basic_Root).Name);
        //            TestHelper.AssertContainsErrors(asmGen.ConsoleLogger, errorMessage);
        //        }
        //    }
        //}
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH24")]
        ...
        //                                            "CG_INH24",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_No_Root_Custom) }))
        //        {
        //            Assembly assy = asmGen.GeneratedAssembly;
        //            Assert.IsNotNull(assy, "Assembly failed to build: " + asmGen.ConsoleLogger.Errors);
        ...
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_INH25")]
        ...
        //                                            "CG_INH25",
        //                                            isCSharp,
        //                                            new Type[] { typeof(Inherit_Custom_Overload) }))
        //        {
        //            // Trigger code generation but don't attempt to build
        //            string generatedCode = asmGen.GeneratedCode;
