...
namespace Luma.SimpleEntity.Tests
{
    ...
    {
        //[TestMethod]
        //[Description("different namespaces both import common types for C#, short type names")]
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_TR_CS")]
        ...
        //[TestMethod]
        //[Description("different namespaces both import common types for C#, full type names")]
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_TR_CS_Full")]
        ...
        //[TestMethod]
        //[Description("different namespaces both import common types for VB, short type names")]
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_TR_VB")]
        ...
        //[TestMethod]
        //[Description("different namespaces both import common types for VB, full type names")]
        //[DeploymentItem(@"Luma.SimpleEntity.Tests\ProjectPath.txt", "CG_TR_VB_Full")]
        ...
        //{
        //    using (AssemblyGenerator asmGen = new AssemblyGenerator(testFolderName, isCSharp, useFullTypeNames, new Type[] { typeof(TypeReferenceDS_Common_Types1), typeof(TypeReferenceDS_Common_Types2) }))
        //    {
