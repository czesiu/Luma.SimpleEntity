...
namespace Luma.SimpleEntity.Tests
{
    ...
    /// </summary>
    [TestClass]
    public class ClientFilesTaskTests
    {
        [Description("ClientFilesTask.NormalizeFolderPath works as expected")]
        [TestMethod]
        public void ClientFilesTask_NormalizeFolderPath()
        {
            // Null throws ArgNull
            ExceptionHelper.ExpectArgumentNullExceptionStandard(() => ClientFilesTask.NormalizeFolderPath(null), "path");

            // Empty path is permitted and does nothing
            string path = ClientFilesTask.NormalizeFolderPath(string.Empty);
        ...
        [Description("ClientFilesTask.SafeFileCopy works and catches expected exceptions")]
        [TestMethod]
        ...
        [Description("ClientFilesTask.SafeFileMove works and catches expected exceptions")]
        [TestMethod]
