...
namespace Luma.SimpleEntity.Server
{
    ...
    /// with a <see cref="DomainService"/> Type via the <see cref="Luma.SimpleEntity.DomainIdentifierAttribute"/>, codegen for the service
    ...
    public abstract class CodeProcessor
    {
        ...
        /// </summary>
        /// <param name="entityDescription">The <see cref="EntityDescription"/> describing the <see cref="DomainService"/> currently being examined.</param>
